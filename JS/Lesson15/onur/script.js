...
function isGreaterOrLess(num1, num2) {
	if (num1 > num2) {
		...
		console.log('First number is equel to second number')
	}
}
...
isNumberPositiveOrNegative(65);
isNumberPositiveOrNegative(-27);
...
isTemperatureCheckFreezing(0);
isTemperatureCheckFreezing(-2);
isTemperatureCheckFreezing(35);
