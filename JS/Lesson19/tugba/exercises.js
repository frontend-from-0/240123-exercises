...
// I HAVE TO BE HONEST. CHAT GPT MY BEST FRIEND. I WOULDN'T DO ANYTHING WITHOUT IT.
class Person {
...
const person1 = new Person("Tugba", 38, "female");
const student1 = new Student("Onder", 45, "male", "IT");
...
const shape1 = new Shape("hexagon", "violet");
shape1.describe();

const square1 = new Square("red", 15);
square1.describe();
console.log("==================================");
...
const myVehicle = new Vehicle('Mercedes', 'A130', 20000);
const myCar = new Car('Volvo', 'V-40', 2022, );
