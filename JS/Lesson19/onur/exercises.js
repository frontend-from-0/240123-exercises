...
const person1 = new Person("Onur", 33, "male");
const student1 = new Student("Emily", 30, "female", "Computer Engineer");
...
const myVehicle = new Vehicle('Bmw', 'M8', 2022);
const myCar = new Car('Honda', 'Cr-v', 2023, 4);
