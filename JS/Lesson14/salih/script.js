...
console.log('Exercise 7: ',stringExercise7.charAt(0), stringExercise7.charAt(9), stringExercise7.charAt(stringExercise7.length - 3));
...
console.log('Exercise 13.1: ', string1Exercise12.includes("%"));
console.log('Exercise 13.2: ', string2Exercise12.includes("%"));
...
console.log('Exercise 14: ',stringExercise14.substring(0, 9));
