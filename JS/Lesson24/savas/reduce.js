...
const sumOfNumbers = numbersEx1.reduce((accumulator, currentValue) => {
...
console.log("Exercise 2:", maxValue);
...
const elementCounts = elements.reduce((accumulator, currentValue) => {
  console.log('accumulator[currentValue]',  accumulator[currentValue], currentValue);
...
const sum = numbersEx4.reduce((accumulator, currentValue) => {return accumulator + currentValue}, 0);
const averageOfNumbers = sum / numbersEx4.length;

console.log("Exercise 4:", averageOfNumbers); 
...
console.log("Exercise 5:", uniqueCount); // Output: 5
